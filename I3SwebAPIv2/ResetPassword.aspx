<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="I3SwebAPIv2.Views.Account.ResetPassword" %>
...
<head>
    ...
    <title>Reset Password | I-3S</title>
    <!-- Favicon-->
    ...
    <script src="<%=ResolveUrl("~/PageJS/ResetPassword.js") %>"></script>
</head>
<body class="signup-page">
    <div class="signup-box">
        <div class="logo">
            <a><img src="Images/ic_logo.png" alt="" style="width:50%;height:50%;" class="center"/></a><br/>
            <small><span style="color:black">INTEGRATED SCHOOL SUPPORT SYSTEMS</span></small>
        </div>
        <div class="card">
            <div class="body">
