...
namespace I3SwebAPIv2.Class
{
    ...
    {
        private int _defaultPasswordLength = 6;
        private int _defaultMaxPasswordAttempts = 9999;
        private bool _defaultIncludeLowercase = false;
        private bool _defaultIncludeUppercase = false;
        private bool _defaultIncludeNumeric = true;
        private bool _defaultIncludeSpecial = false;

        private PasswordGeneratorSetting _settings { get; set; }

        public PasswordGenerator()
        {
            _settings = new PasswordGeneratorSetting(_defaultIncludeLowercase, _defaultIncludeUppercase, _defaultIncludeNumeric, _defaultIncludeSpecial, _defaultPasswordLength, _defaultMaxPasswordAttempts, true);
        }

        public PasswordGenerator(PasswordGeneratorSetting settings)
        {
            _settings = settings;
        }
        ...
        {
            _settings = new PasswordGeneratorSetting(_defaultIncludeLowercase, _defaultIncludeUppercase, _defaultIncludeNumeric, _defaultIncludeSpecial, passwordLength, _defaultMaxPasswordAttempts, true);
        }

        public PasswordGenerator(bool includeLowercase, bool includeUppercase, bool includeNumeric, bool includeSpecial)
        {
            _settings = new PasswordGeneratorSetting(includeLowercase, includeUppercase, includeNumeric, includeSpecial, _defaultPasswordLength, _defaultMaxPasswordAttempts, false);
        }
        ...
        {
            _settings = new PasswordGeneratorSetting(includeLowercase, includeUppercase, includeNumeric, includeSpecial, passwordLength, _defaultMaxPasswordAttempts, false);
        }
        ...
        {
            _settings = new PasswordGeneratorSetting(includeLowercase, includeUppercase, includeNumeric, includeSpecial, passwordLength, maximumAttempts, false);
        }
        ...
        private string GenerateRandomPassword(PasswordGeneratorSetting settings)
        {
        ...
        public bool PasswordIsValid(PasswordGeneratorSetting settings, string password)
        {
