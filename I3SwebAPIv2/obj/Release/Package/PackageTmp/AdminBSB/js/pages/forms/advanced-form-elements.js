$(function () {
    ...
    //Mobile Phone Number
    $demoMaskedInput.find('.mobile-phone-number').inputmask('+999999999999', { placeholder: '+60___________' });
    //Phone Number
    $demoMaskedInput.find('.phone-number').inputmask('+99999999999', { placeholder: '+60_________' });
